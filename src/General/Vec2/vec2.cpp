...
#pragma region Vec2
	...
	Vec2::Vec2(Vector2 v)
	{
		x = v.x;
		y = v.y;
		magnitude = static_cast<float>(sqrt(pow(x, 2) + pow(y, 2)));
	}
	...
	float Vec2::Magnitude(Vec2 a) { return static_cast<float>(sqrt(pow(a.x, 2) + pow(a.y, 2))); }
	float Vec2::Dot(Vec2 a, Vec2 b) { return (a.x * b.x + a.y * b.y); }
	float Vec2::Distance(Vec2 a, Vec2 b) { return static_cast<float>(sqrt(pow(static_cast<double>(a.x) - static_cast<double>(b.x), 2) + pow(static_cast<double>(a.y) - static_cast<double>(b.y), 2))); }
	float Vec2::Angle(Vec2 from, Vec2 to)//Return distance in angles between 2 vectors
	{
		return static_cast<float>(acos(sqrt( pow(static_cast<double>(to.x) + static_cast<double>(from.y), 2) + pow(static_cast<double>(to.y) + static_cast<double>(from.y), 2) )) * RAD2DEG);
	}
...
#pragma region Int2
	...
	float Int2::Magnitude(Int2 a) { return static_cast<float>(sqrt(pow(static_cast<double>(a.x), 2) + pow(static_cast<double>(a.y), 2))); }
	float Int2::Dot(Int2 a, Int2 b) { return static_cast<float>(a.x * b.x + a.y * b.y); }
	float Int2::Distance(Int2 a, Int2 b) { return static_cast<float>(sqrt(pow(static_cast<double>(a.x) - static_cast<double>(b.x), 2) + pow(static_cast<double>(a.y) - static_cast<double>(b.y), 2))); }
